...
import getTPRInitInfo from '@salesforce/apex/PermanacyPlanAdoptionController.getTPRInitialInfos';
...
doInit() {
    ...
    this.isLoading = true;
    getTPRInitInfo({permanencyPlanId : this.permanencyRecId}) 
    .then(result =>{

        this.TPRPicklist = JSON.parse(result);
        this.tprStatus = this.TPRPicklist.TPRStatusPicklist.splice(1);
        this.tprList = this.checkNamespaceApplicable(this.TPRPicklist.tpRList,false);
